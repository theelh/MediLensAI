...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 lg:pt-[8rem] items-center lg:justify-center flex-col">
        <video autoplay muted loop playsinline class="absolute top-0 left-0 w-full h-full object-cover z-0">
                <source src="{{ asset('videos/6917913_Motion_Graphics_Motion_Graphic_3840x2160.mp4') }}" type="video/mp4">
                Your browser does not support the video tag.
            </video>
            @include('layouts.welcnav')
        <div class="flex flex-col z-20 items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] items-center rounded-xl w-full flex-col-reverse lg:max-w-7xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <button class="p-3 py-2 flex border-spacing-3 mb-3 items-center z-20 bg-gray-100 border-2 font-semibold text-[#706f6c] font-satoshi text-[14px] border-white rounded-full"><span class="ph ph-brain mr-2 text-[20px]"></span> Medilens-AI</button>
                    <h1 class="text-[#161D2C] text-[47px] mb-5 leading-[3rem] font-satoshi font-semibold">Making healthcare data accessible & intelligent.</h1>
                    <p class="mb-2 text-[16px] text-[#1c1629] font-Inter">Every day, millions of doctors and patients struggle with complex, unstructured medical data — from handwritten prescriptions and lab results to X-rays and CT scans. MediLens AI was created to bridge that gap.
                    </br></br>
                        Our mission is to transform medical data into understandable insights, so that both doctors and patients can make informed decisions faster and more confidently.
                    </br></br>
                        We believe in a future where artificial intelligence enhances, not replaces, human expertise — empowering healthcare professionals and educating patients.</p>
                </div>
                <div class="bg-white/35 p-9 border border-white border-spacing-2 backdrop-blur-[2px] rounded-3xl relative lg:-ml-px -mb-px lg:mb-0 aspect-[335/376] lg:aspect-auto w-full h-full lg:w-[45%] shrink-0 overflow-hidden">
                    {{-- cover image --}}
                    <h1 class="text-[#161D2C] text-[47px] mb-5 leading-[2rem] font-satoshi font-semibold">Our Vision</h1>
                </br>
                <p class="mb-2 text-[16px] text-[#1c1629] font-Inter">To become the go-to assistant for transforming raw medical data into actionable medical intelligence — accessible to everyone, everywhere.
                </br>We aim to:
                <ul class="list-disc space-y-2 ml-5 text-gray-600 font-Inter text-[16px]">
                    <li>Empower doctors with instant AI insights.</li>
                    <li>Help patients understand their own medical data.</li>
                    <li>Support hospitals in building smart knowledge systems.</li>
                    <li>Promote ethical, explainable, and privacy-first AI in healthcare.</li>
                </ul>
                </p>
                </div>
            </main>
    ...
    <section class="py-20 bg-gray-50">
        <h2 class="font-satoshi text-[35px] text-center font-semibold">Our Technology</h2>
        <div class="relative items-center w-[80vw] z-20 justify-evenly mx-auto mt-[4rem] flex sm:px-6">
        ...
        <div class="max-w-7xl grid grid-cols-2 justify-between mx-auto sm:px-6 lg:px-8">
            <!-- Cercle en dégradé -->
                <div class="absolute z-0 inset-0 top-32 flex justify-center items-center">
                    <div class="w-full h-[300px] rounded-full bg-gradient-to-tr from-gray-300/50 to-white blur-3xl opacity-70"></div>
                </div>
    ...
    <section class="relative bg-white py-[7rem] w-full mx-auto sm:px-6 lg:px-8">
        <!-- Cercle en dégradé -->
                <div class="absolute z-0 mx-auto inset-0 top-32 flex justify-center items-center">
                    <div class="w-full h-[500px] rounded-full bg-gradient-to-tr from-gray-300/50 to-white blur-3xl opacity-70"></div>
                </div>
...
However, it does not provide diagnoses — it assists doctors by highlighting potential areas of concern for further review.
    ...
    <section class="relative bg-white py-[9rem] w-full mx-auto sm:px-6 lg:px-8">
        <div class="relative items-center justify-center flex flex-col bg-gray-100 max-w-5xl mx-auto shadow-md shadow-black/35 border border-white border-spacing-5 py-12 rounded-3xl">
            ...
            <div class="absolute z-0 mx-auto inset-0 top-20 flex justify-center items-center">
                <div class="w-full h-[200px] rounded-full bg-gradient-to-tr from-gray-300/50 to-white blur-3xl opacity-70"></div>
            </div>
    ...
    <footer class="bg-[#FBF9FE] border-black/35 w-full border-t text-black/70 font-satoshi font-semibold p-4 py-7 text-center text-sm">
