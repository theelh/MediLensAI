...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 lg:pt-[8rem] items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex z-20 items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] items-center rounded-xl w-full flex-col-reverse lg:max-w-7xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    ...
                    <h1 class="text-[#161D2C] text-[47px] mb-9 leading-[3rem] font-satoshi font-semibold">Transform Medical Data Into Actionable Insights</h1>
                    <p class="mb-2 text-[18px] text-[#706f6c] font-Inter">Strategic, Medilens-AI steps to build and simplified an medical document, smarter, and stronger with measurable results.</p>
                    <p class="mb-2 text-[18px] text-[#161D2C] font-semibold font-Inter">Turn omplexity to clarity with Medilens-AI in two way :</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            <span class="relative py-1 bg-white">
                                <span class="flex items-center justify-center rounded-full bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-4 h-4 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                    <span class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-2 h-2"></span>
                                </span>
                            </span>
                            <span class="text-gray-700 text-lg font-Inter">
                                Upload documents
                                <a href="{{route('files.index')}}" class="inline-flex mx-5 items-center space-x-2 px-6 py-2 rounded-full border border-white/30 
                                            backdrop-blur-sm bg-white/20 hover:bg-white/30 transition duration-300 
                                            text-[15px] font-medium text-[#161615] shadow-md hover:shadow-lg">
                                    <span>Upload</span>
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span class="text-gray-700 text-lg font-Inter">
                                Ask Doctor with free consultation
                                <a href="{{ route('questions.create') }}"
                                    class="inline-flex mx-5 items-center space-x-2 px-6 py-2 rounded-full border border-white/30 
                                            backdrop-blur-sm bg-white/20 hover:bg-white/30 transition duration-300 
                                            text-[15px] font-medium text-[#161615] shadow-md hover:shadow-lg">
                                        <span class="font-Inter"> Ask Doctor</span>
                                        <span class="ph ph-arrow-right text-[#161615] text-lg"></span>
                                    </a>
                            </span>
                        </li>
                    </ul>
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            <a href="{{route('subscription.choose')}}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-lg shadow-black/35 border-[#8264CA] text-md leading-4 font-bold font-Inter rounded-full text-gray-100 bg-gradient-to-r from-[#391986] to-[#6D54A7] hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                                <i class="ph ph-crown mr-2 text-[22px]"></i>
                                Get Started
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="bg-white/35 p-3 border border-white border-spacing-2 backdrop-blur-[2px] rounded-3xl relative lg:-ml-px -mb-px lg:mb-0 aspect-[335/376] lg:aspect-auto w-full h-full lg:w-[45%] shrink-0 overflow-hidden">
                    {{-- cover image --}}
                    <img class="rounded-3xl" src="{{asset('img/screenshot-for-medilens.png')}}" alt="">
                </div>
            </main>
        </div>
